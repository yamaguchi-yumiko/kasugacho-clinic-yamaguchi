...
//医師情報を取得
$doctor_info = $doctor_info->getDoctorInfo();
...
<main>
    ...
    <section id="hospitalGuide_doctor">
        <h1>医師紹介</h1>
        <?php foreach ($doctor_info as $doctors) : ?>
            <div class="flexbox docter-man">
                <img src="./img/<?=$doctors['img']?>" class="waiting-room" alt="待合室">
                <div class="explain">
                    <h2><?=$doctors['name']?><span class="rs-1000"> <?=$doctors['roman_name']?></span></h2>
                    <div class="explain-box">
                        <h3 class="w-25">専門疾患</h3>
                        <p><?$doctors['specialty_disease']?></p>
                        <p class="w-25">所属学会・認定証</p>
                        <?=nl2br($doctors['belong'])?>
                    </div>
                </div>
                <hr class="sp">
