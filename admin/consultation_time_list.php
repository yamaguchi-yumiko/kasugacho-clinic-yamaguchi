...
<body class="list_conteaner">
    ...
    <main class="list_main">
            ...
            <tr>
                ...
                <td>
                    <?php if (isset($consultation_time[0]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[0]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[1]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[1]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[2]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[2]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[3]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[3]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[4]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[4]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[5]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[5]['consultation_type'])?>
            ...
            <tr>
                ...
                <td>
                    <?php if (isset($consultation_time[7]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[7]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[8]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[8]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[9]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[9]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[10]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[10]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[11]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[11]['consultation_type'])?>
                ...
                <td>
                    <?php if (isset($consultation_time[12]['consultation_type'])) : ?>
                        <?=setMark($consultation_time[12]['consultation_type'])?>
        ...
        <p class="time-buttun"><a href="consultation_time_edit.php?type=edit">編集</a></p>
    </main>
