    ...
    <main class="list_main">
        ...
        <form action="" method="post">
            ...
            <div class="submid_time">
                <p class="time-buttun"><input  type="submit" value="戻る" formaction="consultation_time_edit.php?time_edit"></p>
                <p class="time-buttun"><input  type="submit" value="完了" formaction="consultation_time_done.php?time_done"></p>
            </div>
