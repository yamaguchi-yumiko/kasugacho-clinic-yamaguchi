...
if (isset($_POST['addDone'])) {
    $doctorInfo->addDoctor([
        $_POST['name'], $_POST['roman'], $_POST['gender'], $_POST['specialty'], $_POST['belong'], $_POST['image'],
        $_POST['comment'], $_POST['director'], $_POST['directorcomment']
    ]);
    header('Location: doctor_done.php?doctor&addDone');
    exit;
}

//更新ボタンが押されたらDBを更新する
if (isset($_POST['editDone'])) {
    $doctorInfo->editDoctor([
        $_POST['name'], $_POST['roman'], $_POST['gender'], $_POST['specialty'], $_POST['belong'], $_POST['image'], $_POST['comment'],
        $_POST['director'], $_POST['directorcomment'], $_POST['datetime'], $_GET['id']
    ]);
    header('Location: doctor_done.php?doctor&editDone');
    exit;
}
    ...
    <main class="add_main">
        ...
        <?php if (isset($_GET['editConf'])) : ?>
            ...
            <form action="" method="post">
                ...
                <div class="submid_conteaner">
                    <p><input class="submit" type="submit" value="戻る" formaction="doctor_edit.php?doctor&edit&id=<?=$_GET['id']?>"></p>
                    <p><input class="submit" type="submit" name="editDone" value="編集を完了する"></p>
                </div>
            </form>
        ...
        <?php else : ?>
            ...
            <form action="" method="post">
                ...
                <div class="submid_conteaner">
                    <p><input class="submit" type="submit" value="戻る" formaction="doctor_edit.php?doctor&add"></p>
                    <p><input class="submit" type="submit" name="addDone" value="登録完了する"></p>
                </div>
            <?php endif; ?>
    </main>
