...
<body class="list_conteaner">
    ...
    <main class="list_main">
            ...
            <table class="consultation-edit-listbox">
                ...
                <?php if (isset($_POST['confreturn'])) : ?>
                    <tr>
                        ...
                        <td>
                        <?php else : ?>
                        <td><input type="text" size="10" name="time_name1" value="<?=(isset($time_table[0]['name']) ? $time_table[0]['name'] : '')?>">
                            診察時間<input type="text" size="10" name="start_time1" value="<?= getDateTime($time_table[0]['start_time']) ?>">
                            〜<input type="text" size="10" name="end_time1" value="<?=getDateTime($time_table[0]['end_time'])?>"></td>
                        <td>
                        <?php endif; ?>
                    ...
                    <?php if (isset($_POST['confreturn'])) : ?>
                        ...
                        <td>
                        <?php else : ?>
                        <td><input type="text" size="10" name="time_name2" value="<?=$time_table[1]['name']?>">
                        診察時間<input type="text" size="10" name="start_time2" value="<?=getDateTime($time_table[1]['start_time'])?>">
                        〜<input type="text" size="10" name="end_time2" value="<?=getDateTime($time_table[1]['end_time'])?>"></td>
                        <td>
                        <?php endif ; ?>
                        ...
                        <td>
                            ...
                            <span>備考</span><br>
                            <textarea cols="14" rows="4" name="remarks10" placeholder="例)17:00まで"><?=(isset($_POST['remarks10']) ? $_POST['remarks1'] : '')?></textarea>
                        </td>
                        <td>
                            <label class="consultation-edit-label">
        ...
        <div class="submid_time">
            ...
            <p class="time-buttun"><input type="submit" name="conf" value="確認" formaction="consultation_time_conf.php?consultation&addConf"></p>
        </div>
