                ...
                <tr>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type1">
                                <option value="1" <?=getOption($consultation_time[0]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[0]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[0]['consultation_type'], '99')?>>診察しない</option>
                            </select></label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type2">
                                <option value="1" <?=getOption($consultation_time[1]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[1]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[1]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label"><select name="consultation_type3">
                                <option value="1" <?=getOption($consultation_time[2]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[2]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[2]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label"><select name="consultation_type4" 3>
                                <option value="1" <?=getOption($consultation_time[3]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[3]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[3]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type5">
                                <option value="1" <?=getOption($consultation_time[4]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[4]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[4]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type6">
                                <option value="1" <?=getOption($consultation_time[5]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[5]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[5]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type7">
                                <option value="1" <?=getOption($consultation_time[6]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[6]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[6]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type8">
                                <option value="1" <?=getOption($consultation_time[7]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[7]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[7]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type9">
                                <option value="1" <?=getOption($consultation_time[8]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[8]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[8]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type10">
                                <option value="1" <?=getOption($consultation_time[9]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[9]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[9]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type11">
                                <option value="1" <?=getOption($consultation_time[10]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[10]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[10]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type12">
                                <option value="1" <?=getOption($consultation_time[11]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[11]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[11]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type13">
                                <option value="1" <?=getOption($consultation_time[12]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[12]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[12]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
                    ...
                    <td>
                        <label class="consultation-edit-label">
                            <select name="consultation_type14">
                                <option value="1" <?=getOption($consultation_time[13]['consultation_type'], '1')?>>診察する</option>
                                <option value="2" <?=getOption($consultation_time[13]['consultation_type'], '2')?>> 特別時間</option>
                                <option value="99" <?=getOption($consultation_time[13]['consultation_type'], '99')?>>診察しない</option>
                            </select>
                        </label>
