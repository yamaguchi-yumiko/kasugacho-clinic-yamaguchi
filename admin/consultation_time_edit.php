    ...
    <main class="list_main">
        ...
        <form action="" method="post">
            ...
            <table class="consultation-edit-listbox">
                ...
                <tr>
                    <td>
                        <input type="text" size="10" name="time_name1" value="<?=$time_table[0]['name']?>">
                        診察時間<input type="text" size="10" name="start_time1" value="<?=toTimetableTime($time_table[0]['start_time'])?>">
                        〜<input type="text" size="10" name="end_time1" value="<?=toTimetableTime($time_table[0]['end_time'])?>">
                    </td>
                    ...
                    <td>
                        ...
                        <span>備考</span><br>
                        <textarea cols="14" rows="4" name="remarks1" placeholder="例)17:00まで"><?=(!empty($consultation_time[0]['consultation_type']) ? $consultation_time[0]['remarks'] : '')?></textarea>
                    </td>
                    <td>
                        <label class="consultation-edit-label">
                ...
                <tr>
                    <td>
                        <input type="text" size="10" name="time_name2" value="<?=$time_table[1]['name']?>">
                        診察時間<input type="text" size="10" name="start_time2" value="<?=toTimetableTime($time_table[1]['start_time'])?>">
                        〜<input type="text" size="10" name="end_time2" value="<?=toTimetableTime($time_table[1]['end_time'])?>">
                    </td>
            ...
            <div class="submid_time">
                ...
                <p class="time-buttun"><input type="submit" name="conf" value="確認" formaction="consultation_time_conf.php?type=edit_conf"></p>
            </div>
